...
<template>
    <div class="border border-gray-200 p-3 mb-4 rounded">
        <div v-show="!showForm">
            <h4 class="inline-block text-lg ">{{ song.modified_name }}</h4>
        ...
        <div v-show="showForm">
            ...
            @submit="edit">
                ...
                <button type="submit" class="py-1.5 px-3 rounded text-white mr-1.5 bg-green-600"
                :disabled="in_submission">
                Submit
                </button>
                <button type="button" class="py-1.5 px-3 rounded text-white ml-1.5 bg-gray-600"
