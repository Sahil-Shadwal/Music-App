  ...
  <div class="fixed bottom-0 left-0 bg-white p-5 pb-4 text-left align-top w-full h-16">
    <div class="relative mx-auto">
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        ...
        <!-- Scrub Container  -->
        <span class="block w-full h-2 rounded m-1 mt-0.25 bg-gray-200 relative cursor-pointer"
          @click.prevent="updateSeek">
          <!-- Player Ball -->
          <!-- <span class="absolute top-neg-8 flex mt-0.25 text-gray-800 text-lg"
      ...
      <!-- Duration -->
      <div class="float-left w-7 h-7 leading-3 text-gray-400 mt-0 text-lg w-14 ml-8 mt-2">
